...
.directive('flipFront', function() {
    return {
        ...
        transclude: true,
        template:
            '<div class="face front"><div class="card"><div class="item word-container" ng-transclude></div></div></div>'
    }
})
.directive('flipBack', function() {
    return {
        ...
        transclude: true,
        template:
            '<div class="face back"><div class="card"><div class="item word-container" ng-transclude></div></div></div>'
    }
})
